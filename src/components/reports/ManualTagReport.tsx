...
export function ManualTagReport({
  dateFrom, setDateFrom, dateTo, setDateTo, worker, setWorker, manualTag, setManualTag
}: Props) {
  ...
  const filteredRecords = useMemo(() => {
    return records.filter(record => {
      ...
      if (manualTag) {
        matches = matches && record.manualTag.toLowerCase().includes(manualTag.toLowerCase());
      }
      if (dateFrom) {
  ...
  }, [records, worker, manualTag, dateFrom, dateTo]);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="hidden print:block mb-8">
        ...
        <h3 className="text-xl text-stone-600 mt-1">Manual Tag Report</h3>
      ...
      <div className="flex justify-end gap-2 print:hidden mb-4">
        ...
        <ExportButton 
          data={exportData} 
          filename="manual-tag-report.xlsx" 
          reportName="Manual Tag Report"
